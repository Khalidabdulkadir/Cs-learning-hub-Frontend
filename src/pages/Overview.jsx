...
const Overview = () => {
  ...
  useEffect(() => {
    const fetchTotalProjects = async () => {
      try {
        const response = await fetch("https://cs-learning-hub-backend-2.onrender.com/api/projects/project_count/");
    ...
    const fetchTotalSnippets = async () => {
      try {
        const response = await fetch("https://cs-learning-hub-backend-2.onrender.com/api/snippets/snippet_count/");
        const data = await response.json();
